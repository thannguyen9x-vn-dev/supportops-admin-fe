...
export default function SettingsPage() {
  ...
  const countryOptions = [
    { label: t("countries.unitedStates"), value: "United States" },
    { label: t("countries.canada"), value: "Canada" },
    { label: t("countries.vietnam"), value: "Vietnam" },
  ];
        ...
        <div className={styles.rightColumn}>
          ...
          <section className={styles.card}>
            ...
            <form className={styles.passwordGrid} onSubmit={handlePasswordSubmit(onPasswordSubmit)}>
              ...
              <div className={styles.formActions}>
                <Button size="small" disabled={passwordSubmitState === "saving"} type="submit" variant="contained">
