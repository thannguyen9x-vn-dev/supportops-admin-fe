import { useState, useCallback, useMemo, useEffect, useId, useRef, createElement } from 'react';
...
import { useFormContext, useForm, useController, useFieldArray as useFieldArray$1, FormProvider } from 'react-hook-form';
...
function useTableInlineEdit({ enabled }) {
  ...
  const cancelEditing = useCallback((rowId, columnId) => {
  ...
  const discardRow = useCallback((rowId) => {
    setEditingCells((prev) => {
      const next = {};
...
function useDataTable(options) {
  ...
  const table = useReactTable({
    ...
    getPaginationRowModel: serverSide ? void 0 : getPaginationRowModel(),
  ...
  const goToPage = useCallback((page) => setPagination((prev) => ({ ...prev, pageIndex: page })), []);
  const setPageSize = useCallback((size) => setPagination({ pageIndex: 0, pageSize: size }), []);
  return {
    table,
    sorting,
    columnFilters,
...
function useFormField(name, form) {
  const id = useId();
  const resolvedForm = form ?? useFormContext();
  const {
    field,
...
function useFieldArray(props) {
  ...
  return useFieldArray$1({ ...props, control });
}
var useFormContext2 = useFormContext;
...
function DataTableToolbar({
  ...
  return /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between gap-4", children: [
    /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 text-sm text-gray-600", children: [
      selectedCount > 0 ? /* @__PURE__ */ jsxs("span", { children: [
        selectedCount,
        " selected"
      ] }) : null,
      dirtyRowCount > 0 ? /* @__PURE__ */ jsxs("span", { children: [
        dirtyRowCount,
        " unsaved"
      ] }) : null
    ] }),
    /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
      onExport ? /* @__PURE__ */ jsx("button", { className: "rounded border px-3 py-1 text-sm", onClick: onExport, type: "button", children: "Export" }) : null,
      onBulkDelete ? /* @__PURE__ */ jsx("button", { className: "rounded border px-3 py-1 text-sm text-red-600", onClick: onBulkDelete, type: "button", children: "Delete selected" }) : null,
      onDiscardAll ? /* @__PURE__ */ jsx("button", { className: "rounded border px-3 py-1 text-sm", onClick: onDiscardAll, type: "button", children: "Discard all" }) : null,
      onSaveAll ? /* @__PURE__ */ jsx("button", { className: "rounded bg-blue-600 px-3 py-1 text-sm text-white", onClick: onSaveAll, type: "button", children: "Save all" }) : null
    ] })
  ] });
}
function DataTable({
...
function DataTableColumnHeader({ column, title }) {
  ...
  return /* @__PURE__ */ jsxs(
    "button",
    {
      ...
      children: [
        title,
        /* @__PURE__ */ jsx("span", { className: "text-xs", children: sorted === "asc" ? "\u2191" : sorted === "desc" ? "\u2193" : "\u2195" })
      ]
    }
  );
}
      ...
      children: [
        ...
        /* @__PURE__ */ jsxs(
          "div",
          {
            ...
            children: [
              title || titleElement ? /* @__PURE__ */ jsxs("div", { className: "relative border-b px-6 py-4", children: [
                titleElement ? titleElement : /* @__PURE__ */ jsxs("div", { children: [
                  /* @__PURE__ */ jsx("div", { className: "text-lg font-semibold", children: title }),
                  subtitle ? /* @__PURE__ */ jsx("div", { className: "mt-0.5 text-sm text-gray-500", children: subtitle }) : null
                ] }),
              ...
              /* @__PURE__ */ jsx("div", { className: cn("px-6 py-5", dividers ? "border-b border-t" : ""), children }),
              footer ? /* @__PURE__ */ jsx("div", { className: "flex items-center justify-end gap-2 border-t px-6 py-4", children: footer }) : null
            ]
          }
        )
      ]
  ...
  return /* @__PURE__ */ jsx(
    Dialog,
    {
      ...
      footer: /* @__PURE__ */ jsxs(Fragment, { children: [
        /* @__PURE__ */ jsx("button", { className: "rounded border px-3 py-1.5 text-sm", onClick: handleCancel, type: "button", children: cancelLabel }),
        /* @__PURE__ */ jsx(
          "button",
          {
            className: cn(
      ...
      children: description ? /* @__PURE__ */ jsx("div", { className: "text-sm text-gray-600", children: description }) : null
    }
  );
}
...
function AlertDialog(props) {
  ...
  return /* @__PURE__ */ jsx(
    Dialog,
    {
      onClose,
      open,
      titleElement: /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
        /* @__PURE__ */ jsx("span", { className: `inline-block h-3 w-3 rounded-full ${severityAccent(severity)}` }),
        /* @__PURE__ */ jsx("span", { className: "text-lg font-semibold", children: props.title })
      ] }),
      footer: /* @__PURE__ */ jsx(
        "button",
        {
...
function Form({ form, onSubmit, children, ...props }) {
  return /* @__PURE__ */ jsx(FormProvider, { ...form, children: /* @__PURE__ */ jsx("form", { noValidate: true, onSubmit, ...props, children }) });
}
function FormField({
  name,
  form,
  ...
  return /* @__PURE__ */ jsxs("div", { className: cn("space-y-2", className), children: [
    ...
    description ? /* @__PURE__ */ jsx("p", { className: "text-xs text-gray-500", children: description }) : null,
    children(field),
    field.error ? /* @__PURE__ */ jsx("p", { className: "text-sm text-red-600", id: `${field.id}-error`, role: "alert", children: field.error }) : null
  ] });
}
function TextField({
  name,
  ...
  return /* @__PURE__ */ jsx(FormField, { className, description, form, label, name, required, children: (field) => /* @__PURE__ */ jsx(
    "input",
    {
...
function SelectField({
  ...
  return /* @__PURE__ */ jsx(FormField, { className, description, form, label, name, required, children: (field) => /* @__PURE__ */ jsxs(
    "select",
    {
      "aria-describedby": field["aria-describedby"],
      "aria-invalid": field["aria-invalid"],
      ...
      value: String(field.value ?? ""),
      children: [
        placeholder ? /* @__PURE__ */ jsx("option", { disabled: true, value: "", children: placeholder }) : null,
        options.map((option) => /* @__PURE__ */ jsx("option", { disabled: option.disabled, value: option.value, children: option.label }, option.value))
      ]
    }
  ) });
}
function NumberField({
  ...
  return /* @__PURE__ */ jsx(FormField, { className, description, form, label, name, required, children: (field) => /* @__PURE__ */ jsxs("div", { className: "relative", children: [
    prefix ? /* @__PURE__ */ jsx("span", { className: "absolute left-3 top-1/2 -translate-y-1/2 text-sm text-gray-400", children: prefix }) : null,
    /* @__PURE__ */ jsx(
      "input",
      {
        "aria-describedby": field["aria-describedby"],
    ...
    suffix ? /* @__PURE__ */ jsx("span", { className: "absolute right-3 top-1/2 -translate-y-1/2 text-sm text-gray-400", children: suffix }) : null
  ] }) });
}
function Combobox({
  options,
  ...
  return /* @__PURE__ */ jsxs("div", { className: "relative", children: [
    ...
    combobox.isOpen && combobox.filteredOptions.length > 0 ? /* @__PURE__ */ jsx(
      "ul",
      {
        ...combobox.listProps,
        ...
        children: combobox.filteredOptions.map((option, index) => {
          ...
          return /* @__PURE__ */ createElement(
            ...
            option.description ? /* @__PURE__ */ jsx("div", { className: "text-xs text-gray-500", children: option.description }) : null
          );
        })
      }
    ) : null
...
function SwitchField({
  ...
  return /* @__PURE__ */ jsx(FormField, { className, description, form, label, name, children: (field) => /* @__PURE__ */ jsxs(
    "button",
    {
      "aria-describedby": field["aria-describedby"],
      "aria-invalid": field["aria-invalid"],
...
function CheckboxField({
  ...
  return /* @__PURE__ */ jsx(FormField, { className, description, form, label, name, children: (field) => /* @__PURE__ */ jsx("label", { className: "inline-flex items-center gap-2", children: /* @__PURE__ */ jsx(
    "input",
    {
      "aria-describedby": field["aria-describedby"],
      "aria-invalid": field["aria-invalid"],
...
function TextareaField({
  ...
  return /* @__PURE__ */ jsx(FormField, { className, description, form, label, name, required, children: (field) => {
    ...
    return /* @__PURE__ */ jsxs("div", { className: "space-y-1", children: [
      ...
      countText ? /* @__PURE__ */ jsx("p", { className: "text-right text-xs text-gray-500", children: countText }) : null
    ] });
  } });
}
...
function FileField({
  ...
  return /* @__PURE__ */ jsx(FormField, { className, description, form, label, name, required, children: (field) => {
    ...
    return /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
      ...
      helper.length > 0 ? /* @__PURE__ */ jsx("ul", { className: "space-y-1", children: helper.map((file) => /* @__PURE__ */ jsxs("li", { className: "flex items-center justify-between rounded border border-gray-200 px-2 py-1 text-xs text-gray-600", children: [
        /* @__PURE__ */ jsx("span", { children: file.label }),
        /* @__PURE__ */ jsx(
          "button",
          {
...
function RadioGroupField({
  ...
  return /* @__PURE__ */ jsx(FormField, { className, description, form, label, name, required, children: (field) => /* @__PURE__ */ jsx("div", { className: row ? "flex flex-wrap gap-4" : "space-y-2", children: options.map((option) => /* @__PURE__ */ jsxs("label", { className: "inline-flex items-center gap-2 text-sm text-gray-700", children: [
    /* @__PURE__ */ jsx(
      "input",
      {
        "aria-describedby": field["aria-describedby"],
    ...
    "div",
    {
      ...
      children: /* @__PURE__ */ jsx(
        "div",
        {
          ...
          children: virtualItems.map((virtualItem) => /* @__PURE__ */ jsx(
            "div",
            {
              style: {
  ...
  return /* @__PURE__ */ jsxs(
    "div",
    {
      ...
      children: [
        ...
        isLoadingMore ? /* @__PURE__ */ jsx("div", { className: "py-2 text-center text-sm text-gray-500", children: loadingMoreText }) : null
      ]
    }
  );
}
    ...
    "div",
    {
      ...
      children: /* @__PURE__ */ jsx(
        "div",
        {
          ...
          children: virtualItems.map((virtualRow) => /* @__PURE__ */ jsx(
            "div",
            {
              style: {
                display: "grid",
              ...
              children: virtualRow.data.map((item, colIndex) => {
                ...
                return /* @__PURE__ */ jsx("div", { children: renderItem(item, itemIndex) }, itemIndex);
              })
            },
            virtualRow.key
          ))
...
function MultiCombobox({
  ...
  return /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
    ...
    selected.length > 0 ? /* @__PURE__ */ jsx("div", { className: "flex flex-wrap gap-1", children: selected.map((item, index) => /* @__PURE__ */ jsxs(
      "button",
      {
        className: cn(
        ...
        children: [
          ...
          /* @__PURE__ */ jsx("span", { "aria-hidden": "true", children: "x" })
        ]
      },
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxs("div", { children: [
          ...
          description ? /* @__PURE__ */ jsx("p", { className: "mt-1 text-xs opacity-90", children: description }) : null
        ] }),
...
function Toaster({
  ...
  return /* @__PURE__ */ jsx(
    "div",
    {
      ...
      children: toasts.map((toast) => /* @__PURE__ */ jsx("div", { className: "pointer-events-auto", children: /* @__PURE__ */ jsx(
        Toast,
        {
...
function TableSkeleton({
  ...
  return /* @__PURE__ */ jsxs("div", { className: `space-y-2 ${className ?? ""}`, ...rowSkeleton.containerProps, children: [
    showToolbar ? /* @__PURE__ */ jsxs("div", { className: "flex animate-pulse items-center justify-between gap-2 pb-1", children: [
      /* @__PURE__ */ jsx("div", { className: "h-10 w-72 rounded bg-gray-200" }),
      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
        /* @__PURE__ */ jsx("div", { className: "h-9 w-24 rounded bg-gray-200" }),
        /* @__PURE__ */ jsx("div", { className: "h-9 w-24 rounded bg-gray-200" })
      ] })
    ] }) : null,
    /* @__PURE__ */ jsxs("div", { className: "overflow-hidden rounded-md border", children: [
      /* @__PURE__ */ jsx("div", { className: "animate-pulse border-b bg-gray-50 px-4 py-3", children: /* @__PURE__ */ jsx("div", { className: "h-4 w-1/4 rounded bg-gray-200" }) }),
      /* @__PURE__ */ jsx("div", { className: "animate-pulse p-2", children: rowSkeleton.items.map((rowKey) => /* @__PURE__ */ jsxs(
        "div",
        {
          ...
          children: [
            showCheckbox ? /* @__PURE__ */ jsx("div", { className: "h-4 w-4 rounded bg-gray-200" }) : null,
            colSkeleton.items.map((colKey, colIndex) => /* @__PURE__ */ jsx(
              "div",
              {
    ...
    showPagination ? /* @__PURE__ */ jsxs("div", { className: "flex animate-pulse items-center justify-between px-1 pt-1", children: [
      /* @__PURE__ */ jsx("div", { className: "h-4 w-28 rounded bg-gray-200" }),
      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
        /* @__PURE__ */ jsx("div", { className: "h-8 w-8 rounded bg-gray-200" }),
        /* @__PURE__ */ jsx("div", { className: "h-4 w-16 rounded bg-gray-200" }),
        /* @__PURE__ */ jsx("div", { className: "h-8 w-8 rounded bg-gray-200" })
      ] })
    ] }) : null
  ] });
...
function CardSkeleton({
  ...
  const renderCard = (key) => {
    if (variant === "horizontal") {
      return /* @__PURE__ */ jsxs("div", { className: "flex overflow-hidden rounded-lg border", children: [
        /* @__PURE__ */ jsx("div", { className: "h-[120px] w-[160px] shrink-0 animate-pulse bg-gray-200" }),
        /* @__PURE__ */ jsxs("div", { className: "flex-1 space-y-2 p-4", children: [
          /* @__PURE__ */ jsx("div", { className: "h-5 w-2/3 animate-pulse rounded bg-gray-200" }),
          /* @__PURE__ */ jsx("div", { className: "h-4 w-full animate-pulse rounded bg-gray-200" }),
          /* @__PURE__ */ jsx("div", { className: "h-4 w-1/2 animate-pulse rounded bg-gray-200" })
        ] })
      ] }, key);
    }
    if (variant === "compact") {
      return /* @__PURE__ */ jsx("div", { className: "rounded-lg border p-3", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
        /* @__PURE__ */ jsx("div", { className: "h-8 w-8 animate-pulse rounded-full bg-gray-200" }),
        /* @__PURE__ */ jsxs("div", { className: "flex-1 space-y-1", children: [
          /* @__PURE__ */ jsx("div", { className: "h-4 w-2/3 animate-pulse rounded bg-gray-200" }),
          /* @__PURE__ */ jsx("div", { className: "h-3 w-1/2 animate-pulse rounded bg-gray-200" })
        ] }),
        /* @__PURE__ */ jsx("div", { className: "h-6 w-14 animate-pulse rounded bg-gray-200" })
      ] }) }, key);
    }
    return /* @__PURE__ */ jsxs("div", { className: "overflow-hidden rounded-lg border", children: [
      variant === "media" ? /* @__PURE__ */ jsx("div", { className: "w-full animate-pulse bg-gray-200", style: { height: mediaHeight } }) : null,
      /* @__PURE__ */ jsxs("div", { className: "space-y-2 p-4", children: [
        showHeader ? /* @__PURE__ */ jsxs("div", { className: "mb-2 flex items-center gap-2", children: [
          /* @__PURE__ */ jsx("div", { className: "h-10 w-10 animate-pulse rounded-full bg-gray-200" }),
          /* @__PURE__ */ jsxs("div", { className: "flex-1 space-y-1", children: [
            /* @__PURE__ */ jsx("div", { className: "h-4 w-2/3 animate-pulse rounded bg-gray-200" }),
            /* @__PURE__ */ jsx("div", { className: "h-3 w-1/2 animate-pulse rounded bg-gray-200" })
          ] })
        ] }) : null,
        Array.from({ length: bodyLines }).map((_, index) => /* @__PURE__ */ jsx(
          "div",
          {
        ...
        showActions ? /* @__PURE__ */ jsxs("div", { className: "mt-3 flex items-center gap-2", children: [
          /* @__PURE__ */ jsx("div", { className: "h-8 w-20 animate-pulse rounded bg-gray-200" }),
          /* @__PURE__ */ jsx("div", { className: "h-8 w-20 animate-pulse rounded bg-gray-200" })
        ] }) : null
      ] })
    ] }, key);
...
function FormSkeleton({
  ...
  const renderField = (config, key) => {
    if (config.type === "textarea") {
      return /* @__PURE__ */ jsxs("div", { children: [
        /* @__PURE__ */ jsx("div", { className: "mb-1 h-4 w-24 animate-pulse rounded bg-gray-200" }),
        /* @__PURE__ */ jsx("div", { className: "h-24 animate-pulse rounded bg-gray-200" })
      ] }, key);
    }
    if (config.type === "switch") {
      return /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 py-1", children: [
        /* @__PURE__ */ jsx("div", { className: "h-6 w-11 animate-pulse rounded-full bg-gray-200" }),
        /* @__PURE__ */ jsx("div", { className: "h-4 w-32 animate-pulse rounded bg-gray-200" })
      ] }, key);
    }
    if (config.type === "checkbox") {
      return /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 py-1", children: [
        /* @__PURE__ */ jsx("div", { className: "h-4 w-4 animate-pulse rounded bg-gray-200" }),
        /* @__PURE__ */ jsx("div", { className: "h-4 w-36 animate-pulse rounded bg-gray-200" })
      ] }, key);
    }
    if (config.type === "radio") {
      return /* @__PURE__ */ jsxs("div", { className: "space-y-1", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
          /* @__PURE__ */ jsx("div", { className: "h-4 w-4 animate-pulse rounded-full bg-gray-200" }),
          /* @__PURE__ */ jsx("div", { className: "h-4 w-24 animate-pulse rounded bg-gray-200" })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
          /* @__PURE__ */ jsx("div", { className: "h-4 w-4 animate-pulse rounded-full bg-gray-200" }),
          /* @__PURE__ */ jsx("div", { className: "h-4 w-28 animate-pulse rounded bg-gray-200" })
        ] })
      ] }, key);
    }
    if (config.type === "file") {
      return /* @__PURE__ */ jsxs("div", { children: [
        /* @__PURE__ */ jsx("div", { className: "mb-1 h-4 w-20 animate-pulse rounded bg-gray-200" }),
        /* @__PURE__ */ jsx("div", { className: "h-28 animate-pulse rounded bg-gray-200" })
      ] }, key);
    }
    return /* @__PURE__ */ jsxs("div", { children: [
      /* @__PURE__ */ jsx("div", { className: "mb-1 h-4 w-20 animate-pulse rounded bg-gray-200" }),
      /* @__PURE__ */ jsx("div", { className: "h-12 animate-pulse rounded bg-gray-200" })
    ] }, key);
  };
  const content = /* @__PURE__ */ jsxs(
    "div",
    {
      ...
      style: { display: "flex", flexDirection: "column", gap: spacing * 4 },
      children: [
        showTitle ? /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
          /* @__PURE__ */ jsx("div", { className: "h-7 w-52 animate-pulse rounded bg-gray-200" }),
          /* @__PURE__ */ jsx("div", { className: "h-4 w-72 animate-pulse rounded bg-gray-200" })
        ] }) : null,
        /* @__PURE__ */ jsx(
          "div",
          {
              ...
              return /* @__PURE__ */ jsxs(
                "div",
                {
                  ...
                  children: [
                    ...
                    showDividers && index < fieldConfigs.length - 1 && columns === 1 ? /* @__PURE__ */ jsx("hr", { className: "mt-4 border-gray-200" }) : null
                  ]
                },
                key
              );
        ...
        showActions ? /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-end gap-2", children: [
          /* @__PURE__ */ jsx("div", { className: "h-10 w-24 animate-pulse rounded bg-gray-200" }),
          /* @__PURE__ */ jsx("div", { className: "h-10 w-32 animate-pulse rounded bg-gray-200" })
        ] }) : null
      ]
    }
  );
...
function ListSkeleton({
  ...
  const list = /* @__PURE__ */ jsx("ul", { className: `divide-y ${showDividers ? "divide-gray-200" : "divide-transparent"}`, ...skeleton.containerProps, children: skeleton.items.map((key, index) => /* @__PURE__ */ jsxs("li", { className: `flex items-center gap-3 px-3 ${dense ? "py-2" : "py-3"}`, children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "min-w-0 flex-1", children: [
      /* @__PURE__ */ jsx("div", { className: "h-4 animate-pulse rounded bg-gray-200", style: { width: `${45 + index * 13 % 35}%` } }),
      showSecondaryText ? /* @__PURE__ */ jsx("div", { className: "mt-1 space-y-1", children: Array.from({ length: secondaryLines }).map((_, secondaryIndex) => /* @__PURE__ */ jsx(
        "div",
        {
    ...
    showAction ? /* @__PURE__ */ jsx("div", { className: "h-7 w-16 animate-pulse rounded bg-gray-200" }) : null
  ] }, key)) });
  return /* @__PURE__ */ jsx("div", { className, children: paper ? /* @__PURE__ */ jsx("div", { className: "overflow-hidden rounded border", children: list }) : list });
}
function DetailSkeleton({
  ...
  return /* @__PURE__ */ jsx("div", { className, ...fieldSkeleton.containerProps, children: /* @__PURE__ */ jsxs("div", { className: paper ? "rounded border p-4" : "", children: [
    showHeader ? /* @__PURE__ */ jsxs("div", { className: "mb-4 space-y-3", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1", children: [
        /* @__PURE__ */ jsx("div", { className: "h-3 w-14 animate-pulse rounded bg-gray-200" }),
        /* @__PURE__ */ jsx("div", { className: "h-3 w-2 animate-pulse rounded bg-gray-200" }),
        /* @__PURE__ */ jsx("div", { className: "h-3 w-20 animate-pulse rounded bg-gray-200" }),
        /* @__PURE__ */ jsx("div", { className: "h-3 w-2 animate-pulse rounded bg-gray-200" }),
        /* @__PURE__ */ jsx("div", { className: "h-3 w-28 animate-pulse rounded bg-gray-200" })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "flex items-start justify-between gap-2", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
          /* @__PURE__ */ jsx("div", { className: "h-12 w-12 animate-pulse rounded-full bg-gray-200" }),
          /* @__PURE__ */ jsxs("div", { className: "space-y-1", children: [
            /* @__PURE__ */ jsx("div", { className: "h-6 w-56 animate-pulse rounded bg-gray-200" }),
            /* @__PURE__ */ jsx("div", { className: "h-4 w-40 animate-pulse rounded bg-gray-200" })
          ] })
        ] }),
        showHeaderActions ? /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
          /* @__PURE__ */ jsx("div", { className: "h-9 w-24 animate-pulse rounded bg-gray-200" }),
          /* @__PURE__ */ jsx("div", { className: "h-9 w-24 animate-pulse rounded bg-gray-200" })
        ] }) : null
      ] })
    ] }) : null,
    showTabs ? /* @__PURE__ */ jsx("div", { className: "mb-4 flex items-center gap-4 border-b pb-2", children: Array.from({ length: tabCount }).map((_, index) => /* @__PURE__ */ jsx("div", { className: "h-5 animate-pulse rounded bg-gray-200", style: { width: 70 + index * 10 } }, index)) }) : null,
    /* @__PURE__ */ jsx(
      "div",
      {
        style: {
        ...
        children: fieldSkeleton.items.map((key) => /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("div", { className: "mb-1 h-3 w-24 animate-pulse rounded bg-gray-200" }),
          /* @__PURE__ */ jsx("div", { className: "h-5 w-2/3 animate-pulse rounded bg-gray-200" })
        ] }, key))
      }
    )
